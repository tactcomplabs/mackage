...
The formula lives in the [tactcomplabs/homebrew-mackage](https://github.com/tactcomplabs/homebrew-mackage)
tap and is bumped automatically on each new release tag.
